...
class ProductListResource(Resource):
    def __init__(self):
        ...
        self.parser.add_argument('quantity', type=int, required=False)
        self.parser.add_argument('condition', type=str, required=False)
        self.parser.add_argument('yome', type=str, required=False)
        self.parser.add_argument('brand', type=str, required=False)
        self.parser.add_argument('model', type=str, required=False)
        self.parser.add_argument('dimensions', type=str, required=False)
        self.parser.add_argument('weight', type=float, required=False)
        self.parser.add_argument('material', type=str, required=False)
        self.parser.add_argument('original_packaging', type=bool, required=False)
        self.parser.add_argument('manual_included', type=bool, required=False)
        self.parser.add_argument('working_condition_desc', type=str, required=False)
        self.parser.add_argument('image_url', type=str, required=False)
        self.parser.add_argument('category_id', type=int, required=False)
